...
def day22_solve(data, part2):
    ...
    # spent_mana, my_turn, mana, hp, damage, armor, effects, enemy_hp, enemy_damage
    q: list[tuple[int, bool, int, int, int, int, list[int], int, int]] = [
        (0, True, 500, 50, 0, 0, [0, 0, 0], enemy_hp, enemy_damage)]
    ...
    while q:
        spent_mana, my_turn, mana, hp, damage, armor, curr_effects, enemy_hp, enemy_damage = heappop(
            q)
        ...
        if not my_turn:
            heappush(q, (spent_mana, not my_turn, mana, hp - max(1, enemy_damage - actual_armor),
                     damage, armor, curr_effects + [], enemy_hp, enemy_damage))
        else:
            for cost, extra_damage, _, heal, (idx, timer) in spells:
                ...
                heappush(q, (spent_mana + cost, not my_turn, mana - cost, hp + heal,
                             damage, armor, new_effects, enemy_hp - damage - extra_damage, enemy_damage))
