...
#     cmd = [ "NOT J J", "AND A J", "AND B J", "NOT C T", "AND T J", "AND D J", "NOT A T", "AND B T", "AND C T", "AND D T", "OR T J",  "WALK"]
#     cmd = [ "NOT A J", "NOT C T", "AND D T", "OR T J",  "WALK"]
#     # cmd = [ "NOT A J", "NOT C T", "AND D T", "OR T J",  "RUN"]
#     cmd2 = []
#     for c in cmd:
#         for c2 in c:
#             cmd2.append(ord(c2))
...
def day21_2(data):
    # data = read_input(2019, 2101)
    data = day21_parse_input(data)
    cmd = [ "NOT A J", "NOT C T", "AND D T", "OR T J", "NOT A T", "AND D T", "AND E T", "AND I T", "OR T J",  "NOT H T", "OR E T", "AND T J", "RUN"]
    cmd = [ "NOT A J", "NOT C T", "AND D T", "OR T J",  
...
# #####...##...####
    ...
    "OR T J",
    "RUN"]
    # cmd = [ "NOT A J", "NOT C T", "AND D T", "OR T J", "NOT F T", "AND D T", "OR T J", "AND I J","AND D J", "NOT H T", "AND A T", "NOT T T", "AND T J", "RUN"]
    cmd2 = []
    for c in cmd:
        for c2 in c:
            cmd2.append(ord(c2))
